...
<main id="main-content" class="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 text-white">
	<div class="container mx-auto px-4 py-16">
		<header class="text-center mb-16">
			...
			<div class="flex flex-wrap justify-center gap-4">
				...
				<a
					href="/stories"
					class="bg-violet-600 hover:bg-violet-500 px-8 py-4 rounded-lg font-semibold text-lg transition inline-flex items-center gap-2"
				>
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
